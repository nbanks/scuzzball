...
Implementation
 ...
 Const UpKey=$48;
       ...
       LeftKey=$4B;
       RightKey=$4D;
       LButKey=$39; {Space=$39 Ctrl=$1D}
       RButKey=$38; {Alt}
       GridMovement=6;
       MouseByDefault=True;
       GfxMode=2; {0=Text,1=Mono,2+=MCGA}

       GfxCursor:Array[0..15,0..15] of Byte= { $FF=nothing}
        (($00,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF),
         ($00,$0F,$0F,$0F,$0F,$0F,$0F,$00,$00,$00,$00,$00,$FF,$FF,$FF,$FF),
         ($00,$0F,$00,$00,$00,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$00,$00,$FF,$00,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($00,$FF,$FF,$FF,$FF,$00,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($FF,$FF,$FF,$FF,$FF,$00,$0F,$0F,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF),
         ($FF,$FF,$FF,$FF,$FF,$FF,$00,$00,$00,$FF,$FF,$FF,$FF,$FF,$FF,$FF));
 {$F+}
 var ShowMouse, {If show mouse=0, then ShowMouse}
     ...
     OldInt33,OldInt9:Procedure;
     Left,Right,Up,Down:Boolean;
     ScreenSpot:Word;
     MaxX,MaxY,MinX,MinY:Word;
 Procedure PutMouse;
  var Pos,Hor,Vert,Spot:Word;
 Begin
   If GfxMode>1 then
   Begin
     Spot:=Y*320+X SHR 1;
     For Pos:=0 to 15 do
     Begin
       Move(Mem[$A000:Spot],OldGfxScreen[Pos],16);
       Inc(Spot,320);
     End;
     Vert:=16+Y;
     For Pos:=15 DownTo 0 do
     Begin
       Dec(Spot,320);
       Dec(Vert);
       If Vert<200 then
         For Hor:=0 to 15 do
           If (GfxCursor[Pos,Hor]<>$FF) and (X SHR 1+Hor<320) then
             Mem[$A000:Spot+Hor]:=GfxCursor[Pos,Hor];
     End;
   End Else
   Begin
 ...
 Begin
   ...
   Begin
     ...
     For Pos:=0 to 15 do
     Begin
       Move(OldGfxScreen[Pos],Mem[$A000:Spot],16);
       Inc(Spot,320);
     End;
   End Else
 ...
 Begin
   ...
   If Porter<$80 then
   Begin
     If (Left or Right or Up or Down) and (ShowMouse=0) then EraseMouse;
     If Left then Dec(X,GridMovement SHL (HorSHR-3));
     If Right then Inc(X,GridMovement SHL (HorSHR-3));
     If Up then Dec(Y,GridMovement);
     If Down then Inc(Y,GridMovement);
     If (Y+100<MinY+100) then Y:=MinY;
     If (X+100<MinX+100) then X:=MinX;
     If (Y>MaxY) then Y:=MaxY;
     If (X>MaxX) then X:=MaxX;
     If (Left or Right or Up or Down) and (ShowMouse=0) then PutMouse;
   End;
 ...
 Begin
   ...
   Begin
     Mem[$40:$17]:=Mem[$40:$17] and $F3; {Shut off alt and ctrl}
     Mem[$40:$18]:=Mem[$40:$18] and $FC;
     If GfxMode=1 then ScreenSpot:=$B000
